...
<a
  href="https://wa.me/5493754400392?text=Hola%20Cristian!%20Quiero%20mi%20auditor%C3%ADa%20de%20Maps"
  target="_blank"
  className="fixed bottom-6 right-6 z-50 bg-[#25D366] w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform"
>
  <svg viewBox="0 0 24 24" className="w-8 h-8 fill-white">
    <path d="M19.11 17.47c-.39-1.19-2.35-2.18-3.27-2.31-.88-.12-1.53-.39-2.63.28-1.1.67-4.2 2.73-5.3 1.08-.39-.58-.98-1.9-.98-1.9s1.47-2.35 2.08-3.15c.61-.8 1.22-1.47 1.71-1.08.49.39 1.59 2.08 1.71 2.31.12.23.39.12.67-.12.28-.23 1.71-1.59 1.96-1.9.24-.32.49-.47.12-.95-.36-.49-1.71-2.08-2.35-2.69-.64-.61-1.35-.51-1.83-.39-.49.12-1.83.73-2.69 1.47-.87.74-2.69 2.84-2.2 5.66.49 2.81 2.93 5.08 5.42 5.93 2.5.85 4.2.39 5.66-.12 1.47-.51 2.47-1.47 2.81-2.08.34-.61.34-1.13 0-1.47zM12.05 21.9c-1.66 0-3.29-.42-4.71-1.22l-.34-.2-3.52.92.94-3.43-.22-.36a9.1 9.1 0 01-1.39-4.84c0-5.03 4.09-9.12 9.12-9.12 2.44 0 4.73.95 6.45 2.68a9.06 9.06 0 012.68 6.44c0 5.03-4.09 9.12-9.12 9.12l-.9.11zm7.86-16.98A10.9 10.9 0 0012.05 2c-6.05 0-10.97 4.92-10.97 10.97 0 1.93.5 3.81 1.46 5.47L1 23l4.71-1.23a10.95 10.95 0 005.24 1.34h.01c6.05 0 10.97-4.92 10.97-10.97 0-2.93-1.14-5.68-3.21-7.75l-.8-.47z"/>
  </svg>
</a>
    </div>
  );
